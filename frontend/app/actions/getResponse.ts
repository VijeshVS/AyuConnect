...
const msgs: ChatCompletionMessageParam[] = [
  {
    role: "system",
    content: `You are a medical assistant AI designed to help diagnose potential diseases based on patient symptoms. Ask the patient a series of questions(less than 10) to understand their medical problems. Use the following steps:
...
console.timeLog(process.env["GROQ_API_KEY"]);
